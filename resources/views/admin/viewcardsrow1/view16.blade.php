            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title16}}</td>
                        <td class="border">{{$cards->subtitle16}}</td>
                        <td class="border">{{$cards->youtubelinks16}}</td>
                        <td class="border">{{$cards->description16}}</td>
                        <td class="border">{{$cards->content16}}</td>
                        <td class="border">{{$cards->image16}}</td>
                        <td class="border">{{$cards->video16}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
