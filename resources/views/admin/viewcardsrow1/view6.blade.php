            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title6}}</td>
                        <td class="border">{{$cards->subtitle6}}</td>
                        <td class="border">{{$cards->youtubelinks6}}</td>
                        <td class="border">{{$cards->description6}}</td>
                        <td class="border">{{$cards->content6}}</td>
                        <td class="border">{{$cards->image6}}</td>
                        <td class="border">{{$cards->video6}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
