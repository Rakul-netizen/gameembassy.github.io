            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title10}}</td>
                        <td class="border">{{$cards->subtitle10}}</td>
                        <td class="border">{{$cards->youtubelinks10}}</td>
                        <td class="border">{{$cards->description10}}</td>
                        <td class="border">{{$cards->content10}}</td>
                        <td class="border">{{$cards->image10}}</td>
                        <td class="border">{{$cards->video10}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
