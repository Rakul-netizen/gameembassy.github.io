            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title9}}</td>
                        <td class="border">{{$cards->subtitle9}}</td>
                        <td class="border">{{$cards->youtubelinks9}}</td>
                        <td class="border">{{$cards->description9}}</td>
                        <td class="border">{{$cards->content9}}</td>
                        <td class="border">{{$cards->image9}}</td>
                        <td class="border">{{$cards->video9}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
