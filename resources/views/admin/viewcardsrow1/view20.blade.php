            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title20}}</td>
                        <td class="border">{{$cards->subtitle20}}</td>
                        <td class="border">{{$cards->youtubelinks20}}</td>
                        <td class="border">{{$cards->description20}}</td>
                        <td class="border">{{$cards->content20}}</td>
                        <td class="border">{{$cards->image20}}</td>
                        <td class="border">{{$cards->video20}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
