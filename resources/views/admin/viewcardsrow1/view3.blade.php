            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title3}}</td>
                        <td class="border">{{$cards->subtitle3}}</td>
                        <td class="border">{{$cards->youtubelinks3}}</td>
                        <td class="border">{{$cards->description3}}</td>
                        <td class="border">{{$cards->content3}}</td>
                        <td class="border">{{$cards->image3}}</td>
                        <td class="border">{{$cards->video3}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
