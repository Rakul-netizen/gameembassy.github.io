            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title7}}</td>
                        <td class="border">{{$cards->subtitle7}}</td>
                        <td class="border">{{$cards->youtubelinks7}}</td>
                        <td class="border">{{$cards->description7}}</td>
                        <td class="border">{{$cards->content7}}</td>
                        <td class="border">{{$cards->image7}}</td>
                        <td class="border">{{$cards->video7}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
