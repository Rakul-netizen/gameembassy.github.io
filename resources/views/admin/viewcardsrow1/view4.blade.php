            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title4}}</td>
                        <td class="border">{{$cards->subtitle4}}</td>
                        <td class="border">{{$cards->youtubelinks4}}</td>
                        <td class="border">{{$cards->description4}}</td>
                        <td class="border">{{$cards->content4}}</td>
                        <td class="border">{{$cards->image4}}</td>
                        <td class="border">{{$cards->video4}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
