            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title5}}</td>
                        <td class="border">{{$cards->subtitle5}}</td>
                        <td class="border">{{$cards->youtubelinks5}}</td>
                        <td class="border">{{$cards->description5}}</td>
                        <td class="border">{{$cards->content5}}</td>
                        <td class="border">{{$cards->image5}}</td>
                        <td class="border">{{$cards->video5}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
