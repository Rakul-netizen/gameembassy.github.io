            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title14}}</td>
                        <td class="border">{{$cards->subtitle14}}</td>
                        <td class="border">{{$cards->youtubelinks14}}</td>
                        <td class="border">{{$cards->description14}}</td>
                        <td class="border">{{$cards->content14}}</td>
                        <td class="border">{{$cards->image14}}</td>
                        <td class="border">{{$cards->video14}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
