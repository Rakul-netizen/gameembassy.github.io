            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title8}}</td>
                        <td class="border">{{$cards->subtitle8}}</td>
                        <td class="border">{{$cards->youtubelinks8}}</td>
                        <td class="border">{{$cards->description8}}</td>
                        <td class="border">{{$cards->content8}}</td>
                        <td class="border">{{$cards->image8}}</td>
                        <td class="border">{{$cards->video8}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
