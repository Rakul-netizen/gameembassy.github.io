            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="border">
                        ...
                        <td class="border">{{$cards->title17}}</td>
                        <td class="border">{{$cards->subtitle17}}</td>
                        <td class="border">{{$cards->youtubelinks17}}</td>
                        <td class="border">{{$cards->description17}}</td>
                        <td class="border">{{$cards->content17}}</td>
                        <td class="border">{{$cards->image17}}</td>
                        <td class="border">{{$cards->video17}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </thead>
